...
namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Microsoft::Web::WebView2::Core::ICoreWebView2Find>
    {
        struct WINRT_IMPL_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t __stdcall add_ActiveMatchIndexChanged(void*, winrt::event_token*) noexcept = 0;
            virtual int32_t __stdcall remove_ActiveMatchIndexChanged(winrt::event_token) noexcept = 0;
            virtual int32_t __stdcall add_MatchCountChanged(void*, winrt::event_token*) noexcept = 0;
            virtual int32_t __stdcall remove_MatchCountChanged(winrt::event_token) noexcept = 0;
